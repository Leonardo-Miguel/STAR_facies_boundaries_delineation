...
boundaries_pred_file = '/pgeoprj/godeep/ewac_2/seismic_patterns/datasets/models_predictions/penobscot_15c_boundaries_prediction.npy' # IMPORTANTE! Aqui é o modelo do qual as predições já foram feitas
model_file = '/pgeoprj/godeep/ewac_2/seismic_patterns/datasets/models/parihaka_3a/complete_model.pth'
output_dir = '/pgeoprj/godeep/ewac_2/seismic_patterns/datasets/models_predictions'
output_name = 'parihaka_3a'
